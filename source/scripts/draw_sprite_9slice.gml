///draw_sprite_9slice(sprite,image,x,y,width,height,xscale,yscale,angle,color,alpha,9left,9top,9right,9bottom)

var sprite,image,dx,dy,width,height,xscale,yscale,angle,color,alpha,left,top,right,bottom;
